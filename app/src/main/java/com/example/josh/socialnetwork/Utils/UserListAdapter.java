...
/**
 * Created by jbghostman on 30/11/17.
 */
...
public class UserListAdapter extends ArrayAdapter<User> {
   ...
   public UserListAdapter(@NonNull Context context, @LayoutRes int resourse, @NonNull List<User> objects){

       super(context,resourse,objects);

       mContext = context;
       mInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
       layoutResource = resourse;
       this.mUsers = objects;
   }
